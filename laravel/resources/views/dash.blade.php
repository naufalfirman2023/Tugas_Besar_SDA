            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p class="mb-0 font-sans font-semibold leading-normal text-sm">Konsumen Hari Ini</p>
                      <h5 class="mb-0 font-bold">
                        10
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p class="mb-0 font-sans font-semibold leading-normal text-sm">Barang Masuk</p>
                      <h5 class="mb-0 font-bold">
                        +3,462 
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p class="mb-0 font-sans font-semibold leading-normal text-sm">Barang Terjual</p>
                      <h5 class="mb-0 font-bold">
                        +103,430
                ...
                <div class="flex flex-wrap -mx-3">
                  <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                    <div class="flex flex-col h-full">
                      <p class="pt-2 mb-1 font-semibold">Built by us and for you</p>
                      <h5 class="font-bold">"Kunci sukses dalam bisnis ekspor impor adalah keterampilan beradaptasi, pemahaman pasar global, dan kemampuan memanfaatkan peluang."</h5>
                      <p class="mb-12">"Di era globalisasi ini, bisnis ekspor impor adalah langkah penting dalam menjembatani budaya, mendorong pertumbuhan ekonomi, dan membangun kerjasama internasional yang berkelanjutan."</p>
            ...
            <div class="border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
              <div class="relative h-full overflow-hidden bg-cover rounded-xl" style="background-image: url('../assets/img/ivancik.jpg')">
                ...
                <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                  ...
                  <p class="text-white">"To become the industry leader in delivering innovative solutions that meet the needs and expectations of our customers, while creating a positive impact in society."</p>
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                          <div class="flex px-2 py-1">
                            ...
                            <div class="flex flex-col justify-center">
                              <h6 class="mb-0 leading-normal text-sm">Makanan</h6>
                            </div>
                          </div>
                        </td>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                          <div class="flex px-2 py-1">
                            ...
                            <div class="flex flex-col justify-center">
                              <h6 class="mb-0 leading-normal text-sm">Minuman</h6>
                            </div>
                          </div>
                        </td>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                          <div class="flex px-2 py-1">
                            ...
                            <div class="flex flex-col justify-center">
                              <h6 class="mb-0 leading-normal text-sm">Textile</h6>
                            </div>
                          </div>
                        </td>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                          <div class="flex px-2 py-1">
                            ...
                            <div class="flex flex-col justify-center">
                              <h6 class="mb-0 leading-normal text-sm">Teknologi</h6>
                            </div>
                          </div>
                        </td>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                          <div class="flex px-2 py-1">
                            ...
                            <div class="flex flex-col justify-center">
                              <h6 class="mb-0 leading-normal text-sm">Obat-obatan</h6>
                            </div>
                          </div>
                        </td>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-0 whitespace-nowrap">
                          <div class="flex px-2 py-1">
                            ...
                            <div class="flex flex-col justify-center">
                              <h6 class="mb-0 leading-normal text-sm">Pertambangan (Bahan Baku)</h6>
                            </div>
                          </div>
                        </td>
                        <td class="p-2 align-middle bg-transparent border-0 whitespace-nowrap">
